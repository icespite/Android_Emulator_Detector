...
Fork from https://github.com/strazzere/anti-emulator.

This repo tries to improve the detection content, especially the  emulator running on the android(vmos pro,etc).
